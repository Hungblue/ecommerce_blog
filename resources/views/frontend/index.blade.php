								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="{{ asset('assets/uploads/product/m1.jpg') }}" alt="">
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								...
								<div class="col-md-8 bg-right-nut">
									<img src="{{ asset('assets/uploads/product/image1.png') }}" alt="">
								</div>
							</div>
						</div>
						<!-- //third section -->
								...
								<div class="scroll">
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="{{ asset('assets/uploads/product/k1.jpg') }}" alt="" class="img-fluid">
										</div>
									...
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="{{ asset('assets/uploads/product/k2.jpg') }}" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="{{ asset('assets/uploads/product/k3.jpg') }}" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
