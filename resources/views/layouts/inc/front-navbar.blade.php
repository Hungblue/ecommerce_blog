              ...
              <div class="agile_inner_drop_nav_info p-4">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 multi-gd-img">
                    <ul class="multi-column-dropdown">
                      <li>
                        <a href="/products2">Musical Instruments</a>
                      </li>
                      <li>
                        <a href="/products2">Gaming Consoles</a>
                      </li>
                      <li>
                        <a href="/products2">All Electronics</a>
                      </li>
                      <li>
                        <a href="/products2">Air Conditioners</a>
                      </li>
                      <li>
                        <a href="/products2">Refrigerators</a>
                      </li>
                      <li>
                        <a href="/products2">Washing Machines</a>
                      </li>
                      <li>
                        <a href="/products2">Kitchen & Home Appliances</a>
                      </li>
                      <li>
                        <a href="/products2">Heating & Cooling Appliances</a>
                      </li>
                      <li>
                        <a href="/products2">All Appliances</a>
                      </li>
                    </ul>
                  </div>
                </div>
